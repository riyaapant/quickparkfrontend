...
export default function Register() {
    ...
    const validateForm = (formData) => {
        ...
        if (formData.selectedRole == 'user' && !formData.vehicleNumber.trim()) {
            return {
                isValid: false,
    ...
    const handleFormSubmission = async (e) => {
        ...
        if (!formValidation.isValid) {
            ...
            setErrorMessage('');
            try {
                const response = await axios.post(`http://110.44.121.73:2564/${formData.selectedRole}/signup`, {
    ...
    return (
        <main className="h-screen flex flex-row main max-w-full">
            ...
            <div className='h-full flex flex-col justify-center items-center bg-white w-2/5'>
                    ...
                    <h2 className="text-center text-2xl font-bold mb-10">Create an account</h2>
                    <form className="flex flex-col gap-y-5" onSubmit={handleFormSubmission}>
