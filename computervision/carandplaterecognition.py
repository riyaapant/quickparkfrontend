...
cocomodel=YOLO('C:/Users/user/Boeing_I3C/quickpark/computervision/yolov8n.pt')
...
my_file1 = open("C:/Users/user/Boeing_I3C/quickpark/computervision/coco.txt", "r")
data1 = my_file1.read()
...
while True:    
    ...
    result=cocomodel.predict(frame)
 #   print(result)
    a1=result[0].boxes.data
...
#        print(row)
        ...
        if 'car' in c:
            ...
            cv2.putText(frame,"car",(x3,y3),cv2.FONT_HERSHEY_COMPLEX,0.5,(255,255,0),1)
