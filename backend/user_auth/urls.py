...
from .views import UserRegister,UserLogin,OwnerRegister,OwnerLogin,AdminRegister,AdminLogin,ForgetPassword,EmailVerification,ResetPassword,ChangePassword,Login,Logout
